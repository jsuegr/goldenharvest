		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
			   ...
			   <div class="form-group">
				<label for="mod_nombre" class="col-sm-3 control-label">Descripcion del Componente</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="mod_estado" class="col-sm-3 control-label">Tipo</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_precio" name="mod_precio" placeholder="Precio de venta del producto" title="AGREGA EL PUNTO CON 2 DECIMALES" maxlength="11">
				</div>
			  </div>
