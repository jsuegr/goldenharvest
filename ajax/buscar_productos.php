			  ...
			  <table class="table">
				<tr  class="info">
					...
					<th class='text-right'>Acciones</th>
											...
											<!--  MODIFICACION DEL AJAX EN PRODUCTOS  -->
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($status_producto==0){$estado="Autonomo";}          //Estado 0=Autonomo  1=Interconexion 2=calentadores
						else if ($status_producto==1){$estado="Interconexion";}
						else if ($status_producto==2){$estado="Calentador";}
						else{$estado="Planta";}
