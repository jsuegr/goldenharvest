        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "solucionesenergeticas.com.mx "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
...
while ($row=mysqli_fetch_array($sql))
	...
	<?php 
	                      ...
	                      // SE MANDA PETICION PARA MANDAR A LLAMAR LAS OPERACIONES DE CUENTA 
	$nums++;
	}
...
?>
	...
	<!-- AQUI VA EL PIE DE PAGINA -->
		<?php include("footer_factura.php");?>
